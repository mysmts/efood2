...
form.addEventListener("submit", function (e) {
  ...
  const vrCampoA = document.getElementById("idCampA");//variavel constante para manuseio do id campo A, diferente do anterior para poder limpar os inputs
  const vrCampoB = document.getElementById("idCampB");//variavel constante para manuseio do id campo B, diferente do anterior para poder limpar os inputs
