    ...
    <form onSubmit={form.handleSubmit}>
      ...
      <PaymentContainer className={isPayment ? 'show' : ''}>
        ...
        <div className="buttomContainer">
          ...
          <AddCartButton onClick={backAdress}>Voltar ao endereço</AddCartButton>
        </div>
      </PaymentContainer>
      <ConfirmedContainer className={isConfirmed ? 'show' : ''}>
        <p>Pedido confirmado!</p>
        <p>
          Número do pedido: <span>{data?.orderId}</span>
        </p>
        <p>
          Valor total pago: <span>{priceFormat(priceTotal)}</span>
        </p>
        <div className="buttomContainer">
